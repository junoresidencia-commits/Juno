  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="mt-6 space-y-3">
        {sorted.length === 0 ? (
          <p className="text-slate-500">Sem dados ainda. Faça provas para ver seu desempenho.</p>
        ) : (
          sorted.map(([topic, stats]) => {
            const pct = (stats.correct / stats.total) * 100;
            return (
              <div key={topic} className="rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
