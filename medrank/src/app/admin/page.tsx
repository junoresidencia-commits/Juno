...
export default async function AdminDashboard() {
  ...
  if (usesDemoStore()) {
    ...
    const menu = [
      ...
      { href: '/admin/importar', label: 'Importar CSV', desc: 'Excel / CSV' },
  ...
  const menu = [
    ...
    { href: '/admin/importar/lote', label: 'Importar lote de questões', desc: 'JSON/CSV autoral → rascunho' },
    { href: '/admin/importar/prova', label: 'Importar prova', desc: 'Oficial texto/JSON → revisão' },
    { href: '/admin/questoes/revisao', label: 'Revisão de importação', desc: 'Aprovar antes de publicar' },
    { href: '/admin/importar', label: 'Importar CSV legado', desc: 'Excel / planilha' },
    { href: '/admin/ranking', label: 'Rankings', desc: 'Diário, semanal, mensal, geral' },
