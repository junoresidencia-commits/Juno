...
export default async function AdminDashboard() {
  ...
  if (usesDemoStore()) {
    ...
    const menu = [
      ...
      { href: '/admin/importar/prova', label: 'Importar prova', desc: 'PDF/link/template → revisão' },
  ...
  const menu = [
    ...
    { href: '/admin/importar/prova', label: 'Importar prova', desc: 'PDF/link/template USP·ENARE' },
