  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <details className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
        ...
        <div className="mt-4 space-y-4">
          <p className="text-sm text-slate-600">
            Gera <strong>as duas</strong> disputas do dia:{' '}
            <strong>Residência Geral</strong> + <strong>Nefrologia</strong> (
            {todayTrack}). Usa o banco aprovado (sem OpenAI). Dá para pré-gerar 7,
            14 ou 30 dias de uma vez.
          </p>
          <EnsureDailyExamsButton />
          <AiPaidSettingsCard />
          <BankReadinessPanel />
