/**
 * Expansão expert — Nefrologia adulta (título SBN / residência / hospitalar).
 * Casos inéditos, vinheta completa, distratores clínicos, explicação + diretriz.
 */
const ADV_MASTERS_EXTRA = [
  {
    ...
    options: {
      A: "Nefropatia diabética clássica — apenas IECA",
      B: "Nefropatia do cilindro (cast nephropathy) por cadeia leve: hidratação vigorosa, tratar hipercalcemia, evitar contraste/AINE/IECA na fase aguda de LRA, biópsia se dúvida, e tratamento hematológico urgente (bortezomibe ± dexametasona) com avaliação de plasmaférese em casos selecionados de LRA grave por cast",
      C: "Glomerulonefrite pós-estreptocócica",
      D: "Nefrite lúpica classe IV",
      E: "Hidronefrose por litíase única"
    },
    correct: "B",
    explanation: "Discrepância dipstick vs proteinúria de 24 h + pico monoclonal + LRA sugere cast nephropathy. Prioridade: volume, correção da hipercalcemia e terapia antimieloma rápida. A não explica pico monoclonal. C/D exigem sedimento/imunologia típicos. Pearl: dipstick fraco + proteinúria medida = pense cadeia leve.",
  ...
  },
  {
    ...
    options: {
      A: "Apenas observação ambulatorial",
      B: "Síndrome de lise tumoral: hidratação isotônica agressiva, rasburicase (se disponível) ou alopurinol, monitorização eletrolítica intensiva, tratar hipercalemia/hiperfosfatemia, e preparar TSR precoce se LRA oligúrica ou sobrecarga — evitar alcalinização urinária rotineira com rasburicase",
      C: "Restringir água e iniciar AINE",
      D: "Furosemida isolada sem volume",
      E: "Bicarbonato de sódio como única medida"
    },
    correct: "B",
    explanation: "Cairo-Bishop: hiperuricemia + hiperfosfatemia + hipercalemia + LRA. Volume + redução do ácido úrico são pilares. Rasburicase é preferível em alto risco. Pearl: com rasburicase, alcalinizar urina não é rotina.",
  ...
  },
  {
    ...
    options: {
      A: "Ignorar e manter dose plena",
      B: "Nefrite intersticial aguda imune-mediada por ICI: suspender o checkpoint, avaliar biópsia se dúvida, iniciar corticoide sistêmico (ex. prednisona 0,5–1 mg/kg) e discutir rechallenge só após recuperação com oncologia",
      C: "Obstrução — só US e sonda",
      D: "Apenas hidratação resolve sempre",
      E: "Plasmaférese de rotina"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "AINE para ascite",
      B: "Síndrome hepatorrenal (AKI-HRS): vasoconstritor esplâncnico (terlipressina preferencial quando disponível, ou noradrenalina em UTI) + albumina; avaliar Tx hepático; diálise como ponte se indicado",
      C: "Apenas mais furosemida",
      D: "Biópsia renal imediata em todos",
      E: "Suspender albumina"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Suspender todo diurético e hidratar 3 L",
      B: "Síndrome cardiorrenal congestiva: descongestão guiada (diurético de alça IV ± tiazídico sequencial), avaliar VExUS/PVC, manter IECA/ARNI/SGLT2 se hemodinâmica permitir, evitar AINE; ultrafiltração se falha diurética refratária",
      C: "Diálise imediata só pela creatinina 2,1",
      D: "Dopamina renal “em dose renal” como padrão",
      E: "Suspender SGLT2 definitivamente em qualquer LRA"
    },
    correct: "B",
    explanation: "Na CRS congestiva, o rim melhora com descongestão, não com volume cego. Dopamina renal não tem benefício comprovado. Pearl: congestão venosa renal é tão nociva quanto hipoperfusão.",
  ...
  },
  {
    ...
    options: {
      A: "SF 0,9% em grande volume como primeira linha no SIADH",
      B: "SIADH: restrição hídrica, tratar causa (pneumonia); se sintomático grave (convulsão/coma) usar SF 3% em bolus controlado (meta correção ≤8–10 mEq/L/24 h); vaptanos/ureia em casos selecionados",
      C: "Correção rápida para 140 em 6 h",
      D: "Furosemida + água livre à vontade",
      E: "Desmopressina de rotina"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Água livre oral imediata sem estabilizar choque",
      B: "Primeiro restaurar volemia com SF 0,9% até estabilidade hemodinâmica; depois corrigir água livre (D5W ou água enteral) com meta de queda de Na ≈8–10 mEq/L/24 h",
      C: "Diurético de alça isolado",
      D: "Solução hipertônica 3%",
      E: "Restrição hídrica"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Ignorar e só suplementar K",
      B: "Hiperaldosteronismo primário: confirmar ARR (idealmente com K corrigido), teste confirmatório quando indicado, TC de adrenais e/ou cateterismo de veias adrenais; tratamento com espironolactona/eplerenona ou adrenalectomia se adenoma unilateral",
      C: "Feocromocitoma como primeira hipótese sem metanefrinas",
      D: "Apenas aumentar sal na dieta",
      E: "Conduta expectante isolada, sem tratamento específico da condição apresentada"
    },
    correct: "B",
    explanation: "ARR alto + HAS + hipocalemia = rastrear aldosteronismo primário. Pearl: não tratar só o K — tratar a causa.",
  ...
  },
  {
    ...
    options: {
      A: "ATR proximal (tipo II) — só bicarbonato em mega dose sem investigar",
      B: "ATR distal (tipo I): incapacidade de acidificar urina; tratar com álcali (bicarbonato ou citrato de potássio), corrigir K, investigar causas (Sjögren, lupus, drugs) e acompanhar litíase/nefrocalcinose",
      C: "Acidose láctica",
      D: "Cetoacidose diabética",
      E: "ATR tipo IV (hipoaldosteronismo) — típico com hipercalemia"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Hiporreninemia/hipoaldosteronismo (ATR IV): revisar IECA/BRA/espironolactona/trimetoprim, restrição de K dietético, considerar fludrocortisona em casos selecionados e bicarbonato se acidose sintomática",
      C: "Hipercalemia por insuficiência adrenal primária sem cortisol",
      D: "Apenas resina sem revisar fármacos",
      E: "Diálise imediata obrigatória"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas prednisona oral baixa",
      B: "Indução com rituximabe (ou ciclofosfamida) + glicocorticoide; considerar avacopan para poupar esteroide; plasmaférese em indicações selecionadas (hemorragia alveolar grave / anti-GBM sobreposto), conforme evidências recentes",
      C: "Apenas antibiótico para sinusite",
      D: "IECA isolado",
      E: "Esplenectomia"
    },
    correct: "B",
    explanation: "RAVE mostrou rituximabe não inferior à ciclofosfamida. Avacopan (ADVOCATE) reduz exposição a esteroides. PEXIVAS limitou PLEX de rotina. Pearl: pauci-imune + ANCA = indução imunossupressora imediata.",
  ...
  },
  {
    ...
    options: {
      A: "Apenas observação",
      B: "Plasmaférese diária + ciclofosfamida + corticoide em altas doses; início urgente; prognóstico renal pior se anúria/creatinina muito alta ao diagnóstico",
      C: "Só diálise sem imunossupressão",
      D: "Rituximabe isolado como padrão único",
      E: "Conduta expectante isolada, sem tratamento específico da condição apresentada"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Nenhuma terapia adicional existe",
      B: "Manter IECA/BRA maximizado, adicionar SGLT2i (DAPA-CKD/EMPA-KIDNEY aplicáveis a proteinúria), considerar sparsentan (PROTECT) ou budesonida alvo-intestinal (Nefecon/NefIgArd) em elegíveis, e imunossupressão sistêmica só em casos selecionados de alto risco",
      C: "Ciclofosfamida de rotina para toda IgA",
      D: "Suspender IECA",
      E: "Antibiótico crônico de rotina"
    },
    correct: "B",
    explanation: "Era atual da IgA: nefroproteção + SGLT2 ± terapias alvo (sparsentan/Nefecon). Esteroides sistêmicos de rotina caíram (TESTING). Pearl: proteinúria residual após IECA = intensificar.",
  ...
  },
  {
    ...
    options: {
      A: "Biópsia obrigatória sempre antes de qualquer teste sorológico",
      B: "Membranosa primária PLA2R+: suporte (IECA/BRA, diurético, estatina, anticoagulação se risco) e imunossupressão (rituximabe preferencial — MENTOR) se não remissão ou alto risco; títulos PLA2R guiam resposta",
      C: "Apenas restrição de sal sem IECA",
      D: "Ciclofosfamida oral indefinida em todos",
      E: "Transplante imediato"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas observação",
      B: "Investigar causas secundárias (infecção, drogas, APOL1), nefroproteção máxima (IECA/BRA + SGLT2), imunossupressão se primária genética-negativa/idiopática selecionada; discutir ensaios APOL1-alvo quando disponível",
      C: "Corticoide megadose sem biópsia em adulto negro sempre",
      D: "Diálise imediata obrigatória",
      E: "Antibiótico empírico sem investigação"
    },
    correct: "B",
    explanation: "FSGS colapsante exige caça a secundárias. APOL1 é fator de risco importante. Pearl: colapsante ≠ lesão mínima.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Rituximabe isolado sem MMF/CYC como padrão",
      D: "Suspender HCQ na nefrite",
      E: "AINE contínuo"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Suspender todo imunossupressor",
      D: "Antibiótico isolado",
      E: "Nefrectomia do enxerto imediata de rotina"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Reduzir imunossupressão (primeiro passo), monitorar viremia e função; antivirais específicos têm evidência limitada; biópsia se não distinguir de rejeição",
      C: "Antibiótico de amplo espectro",
      D: "Plasmaférese de rotina",
      E: "Ignorar até perda do enxerto"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Aguardar cultura 72 h sem antibiótico",
      ...
      C: "Só analgésico",
      D: "Trocar para HD no mesmo dia em todos os casos",
      E: "Corticoide intraperitoneal"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Só antipirético e manter cateter sempre",
      B: "Antibiótico IV adequado + fortemente considerar remoção do cateter em S. aureus; lock antibiotic se salvamento tentado em germes selecionados; avaliar endocardite se indicado",
      C: "Trocar fio-guia sem antibiótico",
      D: "Corticoide",
      E: "Conduta expectante isolada, sem tratamento específico da condição apresentada"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Cateter tunelizado permanente como primeira escolha",
      B: "Fístula arteriovenosa nativa (quando anatomia permite), com planejamento precoce; enxerto se FAV inviável; cateter como ponte",
      C: "Port-a-cath de quimioterapia",
      D: "Acesso arterial periférico para punção diária",
      E: "DP obrigatória em todos"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Aumentar calcitriol e cálcio do banho",
      B: "Suspeita de calcifilaxia: cuidados de ferida, suspender warfarina se possível (avaliar anticoagulação alternativa), otimizar dialisado, quelantes não-cálcicos, tiosulfato de sódio IV, controle agressivo de PTH/Ca/P e suporte multidisciplinar",
      C: "Biópsia cutânea profunda de rotina em todos sem cuidado",
      D: "Apenas antibiótico tópico",
      E: "Transplante imediato sem otimizar MBD"
    },
    correct: "B",
    explanation: "Calcifilaxia é emergência dermatológica/nefrológica. Warfarina é fator de risco. Pearl: dor cutânea violácea em dialítico = emergência.",
  ...
  },
  {
    ...
    options: {
      A: "Eritropoetina em dose alta antes de corrigir ferro",
      B: "Repor ferro (IV preferível se oral intolerável/ineficaz) até repor estoques; depois iniciar/ajustar AEE com meta individualizada (geralmente evitar Hb >11,5–13); investigar perdas",
      C: "Transfusão semanal indefinida como primeira linha",
      D: "Ignorar ferro se ferritina >30",
      E: "Suspender IECA para “subir Hb”"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas mais restrição de açúcar sem fármacos",
      B: "Adicionar SGLT2i (se elegível) e considerar finerenona (se K e TFG permitirem) sobre IECA/BRA, otimizar PA e glicemia",
      C: "Suspender IECA",
      D: "AINE diário",
      E: "Diurético tiazídico isolado sem SGLT2"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Meta <150/100 e só tiazídico",
      B: "IECA ou BRA como base na DRC proteinúrica, meta individualizada (frequentemente PAS <120 se tolerado por evidência SPRINT/KDIGO, com cautela), associar outros anti-hipertensivos conforme necessidade",
      C: "Betabloqueador isolado sempre",
      D: "Clonidina como primeira linha",
      E: "Sem tratamento se assintomático"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Restrição extrema de cálcio dietético",
      B: "Aumentar ingestão hídrica (meta diurese ≥2–2,5 L), cálcio dietético adequado nas refeições (liga oxalato), reduzir oxalato/sal, citrato se hipocitratúria, e avaliar causas de hiperoxalúria",
      C: "Vitamina C megadose",
      D: "Apenas litotripsia sem prevenção",
      E: "Alopurinol de rotina em todo oxalato"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Nenhuma terapia específica existe",
      ...
      D: "Nefrectomia bilateral profilática de rotina",
      E: "Corticoide"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Sempre heparina plena sem protocolo",
      B: "Citrato regional (quando protocolo disponível) como preferência ISPD/KDIGO-pratical em muitos centros, com monitorização de gap de cálcio total/ionizado e metabolismo hepático; heparina se citrato inviável",
      C: "Warfarina na CRRT",
      D: "AAS isolado",
      E: "Trombólise de rotina no filtro"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Manter dose plena",
      B: "Ajustar/suspender metformina conforme TFG (em geral não iniciar se TFG <30; reduzir entre 30–45); educar sobre risco de acidose láctica em LRA/hipóxia",
      C: "Dobrar dose para “proteger rim”",
      D: "Trocar por AINE",
      E: "Associar contraste sem pausa"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Ignorar poliúria",
      B: "Suspeitar NDI e DRC por lítio: medir nível sérico, discutir com psiquiatria redução/alternativa, amilorida pode ajudar NDI, monitorar TFG/proteinúria e evitar desidratação",
      C: "Aumentar lítio",
      D: "Diuréticos tiazídicos sem acompanhamento",
      E: "Corticoide"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Nefropatia membranosa anti-PLA2R sempre",
      B: "ATR distal (± nefrite tubulointersticial) associada à Sjögren: álcali, repor K, tratar doença de base e avaliar litíase/nefrocalcinose",
  ...
  },
  {
    ...
    options: {
      A: "Nefropatia por contraste isolada (só nas primeiras 72 h tipicamente)",
      ...
      C: "Endocardite tratada só com diurético",
      D: "Pielonefrite",
      E: "Rabdomiólise por estatina sempre"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Naloxona isolada",
      D: "N-acetilcisteína como antídoto específico",
      E: "Carvão ativado sempre eficaz tardio"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "IECA imediatamente",
      B: "Pré-eclâmpsia com acometimento renal: anti-hipertensivo seguro na gestação, sulfato de magnésio se risco de eclâmpsia, avaliação obstétrica para resolução (definitiva), e suporte de LRA — IECA/BRA contraindicados na gravidez",
      C: "Diurético de alça de rotina em toda gestante",
      D: "Biópsia renal imediata sem avaliar obstetrícia",
      E: "Conduta expectante isolada, sem tratamento específico da condição apresentada"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Tratar como IgA sem complemento",
      B: "C3 glomerulopatia: investigar via alternativa do complemento (incluindo C3Nef), nefroproteção, e terapia direcionada ao complemento/imunossupressão em centros especializados; eculizumabe em casos selecionados",
      C: "Apenas antibiótico",
      D: "PLEX de rotina em todos sem avaliação",
      E: "Observação sem nefroproteção"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Só dieta sem fármacos",
      B: "IECA/BRA, SGLT2i, controle de PA/glicemia/lipídeos, evitar nefrotóxicos, vacinação, encaminhar à nefrologia por TFG <45 e albuminúria A3, e planejar acesso/Tx se progressão",
      C: "Suplemento “detox renal”",
      D: "Corticoide crônico",
      E: "Diálise imediata"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Só resina de K indefinidamente no EAP",
      D: "Bicarbonato isolado resolve EAP",
      E: "Diurético se anúrico absoluto sempre funciona"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Só dieta baixa em K",
      B: "Gluconato/cloreto de cálcio IV para estabilizar membrana → shift (insulina+glicose ± beta-agonista) → remoção (resina/patiromer/diurético/diálise)",
      C: "Digoxina",
      D: "Succinilcolina",
      E: "Observação sem ECG"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Alta hospitalar",
      B: "Tratar como emergência pulmão-rim: estabilizar via aérea, coletar ANCA/anti-MBG/anti-GBM, biópsia quando segura, e iniciar imunossupressão ± PLEX conforme probabilidade e gravidade — não atrasar por resultado demorado se vida em risco",
      C: "Apenas antitussígeno",
      D: "Heparina plena empírica",
      E: "Conduta expectante isolada, sem tratamento específico da condição apresentada"
    },
    correct: "B",
    explanation: "Síndrome pulmão-rim é emergência. Pearl: trate o doente, não espere o laboratório eterno. Distratores descartados por não explicarem o quadro clínico completo ou por atrasarem terapia com benefício comprovado. Pearl: correlacione vinheta, labs e diretriz antes de escolher.",
  ...
  },
  {
    ...
    options: {
      A: "Biópsia nunca muda conduta",
      B: "Biópsia renal está indicada para definir padrão histológico e terapia (após coagulação/PA adequadas e exclusão de obstrução); contraindicações relativas devem ser pesadas",
      C: "Biópsia só em crianças",
      D: "US normal contraindica biópsia sempre",
      E: "Proteinúria isolada leve nunca se biopsia, sem nuance"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Vitamina C megadose",
      B: "Nefropatia por oxalato entérico: hidratação, cálcio dietético com refeições, reduzir oxalato/gordura, citrato, tratar esteatorreia e evitar vitamina C alta; dialise se necessário",
      C: "Restrição de cálcio dietético",
      D: "Apenas AINE",
      E: "Alopurinol como antídoto específico"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "AINE em dose alta sem dialise",
      B: "Iniciar/intensificar dialise (pericardite urêmica/dialítica); evitar anticoagulação agressiva; avaliar tamponamento",
      C: "Alta com analgésico",
      D: "Corticoide isolado sem TSR",
      E: "Antibiótico empírico sem avaliação"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "DOAC em dose plena sem ajuste",
      B: "Individualizar: warfarina ou DOAC com dose ajustada à TFG (ex. apixabana frequentemente preferida em TFG baixa), reavaliar sangramento, evitar nefrotóxicos e monitorar",
      C: "AAS sozinho sempre equivalente",
      D: "Sempre contraindicado anticoagular em TFG <30",
      E: "Heparina oral"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "DRC estável TFG 50 sem atividade",
      B: "PTT com ADAMTS13 muito baixo / anti-MBG com hemorragia alveolar / algumas rejeições humorais hiperagudas — PLEX é terapêutica de resgate",
      C: "Hipertensão essencial",
      D: "ITU simples",
      E: "Cisto renal simples"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Ignorar UF se Kt/V “bate meta”",
      ...
      C: "Reduzir tempo de dwell em todos os alto transportadores sem critério",
      D: "Suspender DP no primeiro edema",
      E: "Aumentar cálcio oral"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas urocultura",
      B: "Doença de Fabry: dosar atividade de α-galactosidase A (homens), Lyso-Gb3, genética GLA; biópsia com corpos de inclusão; terapia de reposição enzimática/chaperona conforme elegibilidade",
      C: "Ignorar história familiar",
      D: "Tratar como IgA sem exame",
      E: "Esplenectomia"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Síndrome de Alport: genética (COL4A5/A3/A4), IECA precoce mesmo com proteinúria leve, aconselhamento familiar e evitar biópsia desnecessária se genética diagnóstica",
      C: "Corticoide de rotina",
      D: "Tonsilectomia cura",
      E: "Observar sem IECA até TFG <15"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Imunossupressão pesada imediata em todos",
      B: "GN pós-estreptocócica: suporte (sal, diurético, anti-hipertensivo), antibiótico se infecção ativa, diálise se AEIOU; biópsia se atípico/persistente (adulto tem mais diferencial)",
      C: "IECA na fase oligúrica aguda sem cautela",
      D: "Plasmaférese de rotina",
      E: "Negar relação com infecção"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas diurético",
      B: "TARV imediata (tratamento da HIVAN), IECA/BRA, suporte; biópsia para confirmar FSGS colapsante e excluir outras glomerulopatias",
      C: "Corticoide sem TARV",
      D: "Suspender TARV se proteinúria",
      E: "Transplante sem controlar HIV"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Apenas vacina da febre amarela obrigatória",
      D: "Vacinas vivas liberadas na imunossupressão pesada",
      E: "Sem indicação de hepatite B"
    },
    correct: "B",
