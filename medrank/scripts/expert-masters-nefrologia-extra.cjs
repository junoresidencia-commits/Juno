...
const ADV_MASTERS_EXTRA = [
  ...
  },
  {
    ...
    options: {
      ...
      D: "Escalar para terapia de substituição renal de imediato apenas pelo valor laboratorial, sem critérios clínicos de indicação Esta abordagem atrasa a terapia com melhor evidência para o quadro apresentado.",
      E: "Síndrome de lise tumoral: hidratação isotônica agressiva, rasburicase (se disponível) ou alopurinol, monitorização eletrolítica intensiva, tratar hipercalemia/hiperfosfatemia, e preparar TSR precoce."
    },
    correct: "E",
  ...
  },
  {
    ...
    options: {
      ...
      E: "Trocar metformina por sulfonilureia de alta dose sem ajustar à função renal nem risco de hipoglicemia Esta abordagem atrasa a terapia com melhor evidência para o quadro apresentado."
    },
    correct: "A",
  ...
  },
  {
    ...
    options: {
      ...
      E: "Remover o acesso/cateter em todo episódio febril antes de coletar culturas e iniciar antibiótico dirigido Esta abordagem atrasa a terapia com melhor."
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Indicar procedimento invasivo imediato (biópsia/cirurgia/dreno) antes de otimizar medidas clínicas e confirmar a hipótese com exames dirigidos Esta abordagem atrasa a terapia com melhor evidência para o quadro apresentado.",
      B: "Trocar metformina por sulfonilureia de alta dose sem ajustar à função renal nem risco de hipoglicemia Esta abordagem atrasa a terapia com melhor evidência para o quadro apresentado.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Indicar apenas oxigênio a 100% sem titulação e sem broncodilatador, adiando corticoide sistêmico Esta abordagem atrasa a terapia com melhor evidência para o quadro apresentado.",
