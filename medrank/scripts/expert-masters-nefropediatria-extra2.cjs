/**
 * Expansão expert II — Nefrologia Pediátrica (SBNPed / IPNA / residência).
 */
const PED_MASTERS_EXTRA2 = [
  {
    ...
    options: {
      A: "Apenas ITU — antibiótico sem imagem",
      B: "Suspeitar trombose de veia renal/outros: imagem vascular urgente, anticoagulação conforme protocolo e tratamento da SN",
      C: "Nefrectomia imediata sem imagem",
      D: "Plasmaférese de rotina em toda dor lombar"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas virose — sem antibiótico possível",
      B: "Peritonite espontânea (pneumococo clássico): ATB empírico + culturas; garantir vacinas pneumocócicas/influenza no calendário da SN",
      C: "Apendicectomia sem avaliação",
      D: "Corticoide em megadose como antimicrobiano"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "NPHS2 apenas — sem risco tumoral",
      B: "WT1 (Denys-Drash/Frasier spectrum): genética, US seriada para Wilms e manejo multidisciplinar; IS muitas vezes ineficaz",
      C: "Apenas observação sem genética",
      D: "Diagnóstico de PSGN neonatal"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas restrição salina",
      B: "Metilprednisolona + rituximabe ou ciclofosfamida conforme protocolo; dialisar se indicação; plasmaférese se DAH/anti-MBG",
      C: "Antibiótico isolado por 6 meses",
      D: "Observação expectante sem IS"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Plasma fresco abundante de rotina em todos",
      ...
      C: "Eculizumab imediato como padrão pneumococo",
      D: "Corticoide sem antibiótico"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas STEC sem labs metabólicos",
      B: "Defeito cobalamina C: hidroxicobalamina + betaina/folato conforme protocolo metabólico + suporte de MAT",
      C: "Rituximabe — hipótese inadequada para o quadro",
      D: "Tolvaptan — hipótese inadequada para o quadro"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas observação",
      B: "Diálise/TSR precoce quando hiperK/hiperP/volume/uremia refratários — não atrasar por “esperar rasburicase agir sozinho”",
      C: "AINE para hiperuricemia",
      D: "Restrição absoluta de todo fósforo IV sem dialisar em sobrecarga"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Ignorar febre",
      B: "US/TC para coleção/abscesso/obstrução; drenagem se abscesso significativo + ATB prolongado",
      C: "Corticoide — hipótese inadequada para o quadro",
      D: "Trocar para antifúngico sem cultura"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Nunca desobstruir",
      B: "Aliviar obstrução (stent/vesicostomia/cirurgia conforme equipe) + ATB; preservar néfrons",
      C: "Apenas observação sem urologia",
      D: "Nefrectomia bilateral"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Ignorar acidose se assintomático",
      B: "Alcalinizar (citrato/bicarbonato) visando HCO₃ no alvo pediátrico — acidose prejudica crescimento e osso",
      C: "Apenas GH sem corrigir acidose",
      D: "Diuréticos tiazídicos como alcalinizantes"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Calcitriol em dose alta sem controlar fósforo",
      B: "Dieta/quelante de fósforo, vitamina D nativa se deficiente, depois análogos ativos/calcimimético conforme idade/disponibilidade e alvos KDIGO pediátricos",
      C: "Paratireoidectomia imediata em todo PTH >300",
      D: "Suplemento livre de fósforo sem labs"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Normalizar PA em 5 minutos com nifedipina sublingual de rotina",
      B: "Redução gradual em ambiente monitorado com agentes IV tituláveis; investigar causa secundária",
      C: "Alta com tiazídico oral apenas",
      D: "IECA sublingual único sem monitorização"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "HAS essencial pura",
      B: "Coarctação de aorta — ecocardiograma/angiorressonância e encaminhamento cardiológico",
      C: "Apenas feocromocitoma",
  ...
  },
  {
    ...
    options: {
      A: "Diabetes mellitus tipo 1 exclusivo",
      B: "Fanconi proximal: investigar cistinose e outras causas genéticas/tóxicas; repor bicarbonato/fosfato/K e tratar causa",
      C: "ATR distal pura sem perda de fosfato",
      D: "SIADH — hipótese inadequada para o quadro"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas diurético",
      B: "Cisteamina (e cisteamina oftálmica), além de reposição de perdas do Fanconi e suporte nutricional",
      C: "Eculizumab — hipótese inadequada para o quadro",
      D: "Rituximabe — hipótese inadequada para o quadro"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas restrição hídrica",
      B: "Hidratação + piridoxina se responsivo + RNA-terapia (lumasiran) / opções hepato-renais conforme tipo; evitar vitamina C megadose",
      C: "Alopurinol específico para oxalato",
  ...
  },
  {
    ...
    options: {
      A: "Cistina — só tiopronina",
      B: "Estruvita (infeccioso): remoção completa do cálculo + ATB direcionado; corrigir anomalias urológicas",
      C: "Ácido úrico — só alcalinizar",
      D: "Observação sem urologia"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Só IECA sem imunossupressão no flare proliferativo",
  ...
  },
  {
    ...
    options: {
      A: "Corticoide proibido sempre",
      B: "Pode aliviar dor abdominal grave; não previne nefrite de forma confiável — monitorar urina seriadamente",
      C: "Corticoide cura e elimina necessidade de follow-up urinário",
  ...
  },
  {
    ...
    options: {
      A: "NPHS1 isolado",
      B: "HNF1B (RCAD): aconselhar genética, acompanhar rim/Mg/glicemia e anomalias Müllerianas/urogenitais",
      C: "CFH — hipótese inadequada para o quadro",
      D: "COL4A5 exclusivo"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Doação materna sempre segura e preferencial",
      B: "Mães portadoras COL4A5 têm risco próprio de DRC — doação exige avaliação criteriosa; preferir doador não portador quando possível",
      C: "Transplante é contraindicado no Alport",
      D: "Sempre usar eculizumab no enxerto"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Porque nunca tem peritonite",
      B: "Preserva vida escolar/familiar, evita deslocamentos diários à HD e acesso vascular repetido — quando houver suporte domiciliar",
      C: "Porque é sempre superior em clearance a qualquer HD",
      D: "Porque não precisa de treinamento familiar"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Nenhuma — sempre dialisar 2 anos antes",
      B: "Evita diálise e suas complicações; melhor sobrevida do enxerto/paciente em muitas séries — preparar imunologia/urologia a tempo",
      C: "Aumenta obrigatoriamente rejeição hiperaguda",
      D: "Impede vacinação prévia"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Apenas vitamina D oral na crise convulsiva",
      B: "Gluconato de cálcio IV cuidadoso + investigar causa (hipopara, mãe diabética, DiGeorge etc.)",
      C: "Bicarbonato como primeira medida",
      D: "Furosemida — hipótese inadequada para o quadro"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Hipermagnesemia neonatal: suporte ventilatório, cálcio IV se necessário, hidratação; diálise rara/se grave",
      C: "Hipernatremia hipovolêmica típica",
      D: "Tireotoxicose neonatal"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Necrose cortical sempre irreversível",
      B: "IRA hemodinâmica por inibição de prostaglandinas (aferente); suporte, evitar outros nefrotóxicos, geralmente reversível",
      C: "GN proliferativa típica",
      D: "Obstrução por válvula sem imagem"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Tumor de Wilms típico da primeira semana",
      B: "Trombose de veia renal: US/Doppler, suporte, anticoagulação selecionada em centro experiente",
      C: "PSGN — hipótese inadequada para o quadro",
      D: "Hidronefrose sem Doppler"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "IECA é seguro em qualquer idade sem ajuste",
      B: "RN/prematuros são hipersensíveis a IECA — evitar ou usar com extremo cuidado; suspender e suportar",
      C: "Apenas tiazídico causa esse quadro",
      D: "É efeito desejável de nefroproteção neonatal"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Aumentar a dose",
      B: "Reduzir/ajustar dose, excluir interações (azole, macrolídeo), hidratar e reavaliar; biópsia se não explicar",
      C: "Antibiótico empírico sem nível",
      D: "Suspender todos imunossupressores abruptamente sem plano"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Cistinose sem catarata típica precoce",
      B: "Síndrome de Lowe (OCRL) — manejo de tubulopatia + oftalmo/neuro e genética",
      C: "Alport clássico",
      D: "Bartter puro sem Fanconi"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "PKD1 — hipótese inadequada para o quadro",
      B: "LMX1B (nail-patella): seguimento de proteinúria/DRC e IECA quando indicado",
      C: "NPHS2 exclusivo",
      D: "CFH — hipótese inadequada para o quadro"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "SN corticoresistente obrigatória",
      B: "Proteinúria ortostática benigna na maioria — confirmar com split day/night e seguir; investigar se outros achados",
      C: "Indicação de biópsia imediata em todos",
      D: "Diálise — hipótese inadequada para o quadro"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Vacinas inativadas/mRNA são geralmente recomendadas; vivas continuam restritas sob IS",
      B: "Nunca vacinar imunossuprimidos contra COVID",
      C: "Só vacina viva é permitida",
      D: "Suspender MMF 3 meses obrigatoriamente antes de qualquer vacina inativada"
    },
    correct: "A",
  ...
  },
  {
    ...
    options: {
      A: "Tratar sempre com base só no saco coletor",
      B: "Confirmar com método fiável (cateterismo/punção) antes de fechar diagnóstico/ATB prolongado, salvo sepse",
      C: "Negar qualquer exame de urina",
      D: "Usar só urina do chão"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Deixar todas as vacinas para depois do Tx",
      B: "Atualizar calendário antes do Tx (incluindo vivas quando ainda possível/seguro); pós-Tx evitar vivas",
      C: "BCG após Tx com IS plena",
      D: "Vacinas são irrelevantes no dialítico"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Punir com alta compulsória apenas",
      ...
      C: "Ignorar causas sociais",
      D: "Suspender seguimento"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Sal livre ilimitado",
      B: "Restrição de sódio adequada à idade + IECA/BRA conforme indicação; educar a família",
      C: "Dieta cetogênica obrigatória",
      D: "Suplemento de bicarbonato de sódio ad libitum sem labs"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Sem papel histórico na SN",
      B: "Poupador de corticoide em SDNS/FRNS selecionados; monitorar neutropenia/ANCA e hepatotoxicidade",
      C: "Substitui biópsia em SRNS genética",
      D: "Antibiótico de amplo espectro contínuo"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Nada — sempre primária idêntica ao adulto",
      B: "Causas secundárias (lúpus, hep B/C, fármacos, malignidade rara) e anticorpos (PLA2R/THSD7A/extensões); tratar causa + antiproteinúrico/IS conforme gravidade",
      C: "Eculizumab de primeira linha",
      D: "Nefrectomia — hipótese inadequada para o quadro"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Restrição de diurético e hidratação livre",
      B: "Otimizar débito cardíaco/congestão; BRT/UF ou diálise peritoneal em falência diurética — decisão cardio-nefro",
      C: "AINE para “proteger rim”",
      D: "IECA em choque frio sem ajuste"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Puberdade não altera nada na DRC",
      B: "Crescimento, sexualidade, adesão e preparação para transição aumentam risco e demanda de cuidado estruturado",
      C: "Pode abandonar IECA na adolescência",
      D: "Vacinas deixam de importar"
    },
    correct: "B",
  ...
  },
  {
    ...
    options: {
      A: "Nenhum risco de recorrência",
      B: "Profilaxia/tratamento com inibidor de C5 no peri-Tx conforme genética/risco, além de imunologia padrão",
      C: "Apenas antibiótico meningocócico sem vacina/C5i quando indicado",
      D: "Contraindicação absoluta a qualquer Tx"
    },
    correct: "B",
